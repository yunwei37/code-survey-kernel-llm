...
\begin{itemize}
    \item We introduce \sys, the first multi-agent LLM framework to emulate OSS stakeholder personas for socio-technical analysis of the Linux kernel. Unlike single-model approaches and existing multi-agent systems~\cite{lmase2024,agent4se2024}, our framework employs specialized agents that mirror real OSS stakeholder perspectives, transforming software archaeology into systematic empirical analysis.
